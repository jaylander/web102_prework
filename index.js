...
let totalBackers = GAMES_JSON.reduce((acc, backer) => {
...
let totalRaised = GAMES_JSON.reduce((acc, pledge) => {
...
let displayStr = `A total of ${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedGames ? unfundedGames.length + " games" : "1 game"} remain unfunded. We need your help to fund these amazing games!`;
...
secondPledgeGame.innerHTML = secondGame.name;
